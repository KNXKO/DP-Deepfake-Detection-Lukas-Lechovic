...
"""
================================================================================
AIDE THRESHOLD ANALYSIS SCRIPT
================================================================================
...
Usage:
  # Single threshold
  python analyze_results.py --results_dir vysledky/MyDataset_full_results --threshold 0.6

  # Compare multiple thresholds
  python analyze_results.py --results_dir vysledky/MyDataset_full_results \
...
def plot_threshold_comparison(all_metrics, output_dir):
    ...
    ax.set_title('AIDE Detector - Metrics vs. Threshold', fontsize=14)
...
def main():
    parser = argparse.ArgumentParser(
        description='AIDE Threshold Analysis - Recompute metrics at different thresholds',
...
Examples:
  ...
  python analyze_results.py --results_dir vysledky/MyDataset_full_results \\
    ...
    parser.add_argument('--threshold', type=float, default=None,
                        help='Single threshold to evaluate (default: 0.5)')
